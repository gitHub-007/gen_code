...
<title>${message("admin.plugin.ccbPayment.setting")} - Powered By PTNETWORK</title>
...
<body>
	<div class="breadcrumb">
		${message("admin.plugin.ccbPayment.setting")}
	</div>
	<form id="inputForm" action="update" method="post">
		<table class="input">
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.ccbPayment.branchId")}:
				</th>
				<td>
					<input type="text" name="branchId" class="text" value="${pluginConfig.getAttribute("branchId")}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.ccbPayment.posId")}:
				</th>
				<td>
					<input type="text" name="posId" class="text" value="${pluginConfig.getAttribute("posId")}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.ccbPayment.partner")}:
				</th>
				<td>
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.ccbPayment.key")}:
				</th>
				<td>
					<input type="text" name="key" class="text" value="${pluginConfig.getAttribute("key")}" maxlength="400" />
				</td>
			</tr>
			<tr>
				<th>
					${message("admin.plugin.ccbPayment.isPhishing")}:
				</th>
				<td>
					<input type="checkbox" name="isPhishing" value="true"[#if pluginConfig.getAttribute("isPhishing") == "true"] checked="checked"[/#if] />
				</td>
			</tr>
			<tr>
				<th>
