...
<title>${message("admin.plugin.alipayDirectPayment.setting")} - Powered By PTNETWORK</title>
...
<body>
	<div class="breadcrumb">
		${message("admin.plugin.alipayDirectPayment.setting")}
	</div>
	<form id="inputForm" action="update" method="post">
		<table class="input">
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.alipayDirectPayment.partner")}:
				</th>
				<td>
					<input type="text" name="partner" class="text" value="${pluginConfig.getAttribute("partner")}" maxlength="200" />
					<a href="http://bizpartner.alipay.com/ptnetwork/" target="_blank">[${message("admin.plugin.alipayDirectPayment.register")}]</a>
					<a href="https://b.alipay.com/order/pidKey.htm?pid=2088101227516250&product=fastpay" target="_blank">[${message("admin.plugin.alipayDirectPayment.query")}]</a>
				</td>
			</tr>
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.alipayDirectPayment.key")}:
				</th>
				<td>
