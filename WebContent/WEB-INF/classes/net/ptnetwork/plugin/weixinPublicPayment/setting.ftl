...
<title>${message("admin.plugin.weixingPublicPayment.setting")} - Powered By PTNETWORK</title>
...
<body>
	<div class="breadcrumb">
		${message("admin.plugin.weixingPublicPayment.setting")}
	</div>
	<form id="inputForm" action="update" method="post">
		<table class="input">
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.weixingPublicPayment.appId")}:
				</th>
				<td>
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.weixingPublicPayment.appSecret")}:
				</th>
				<td>
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.weixingPublicPayment.mchId")}:
				</th>
				<td>
					<input type="text" name="mchId" class="text" value="${pluginConfig.getAttribute("mchId")}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.weixingPublicPayment.apiKey")}:
				</th>
				<td>
					<input type="text" name="apiKey" class="text" value="${pluginConfig.getAttribute("apiKey")}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
