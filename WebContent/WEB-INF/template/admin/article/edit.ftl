...
<title>${message("admin.article.edit")} - Powered By PTNETWORK</title>
	...
	<form id="inputForm" action="update" method="post">
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					<textarea id="content" name="content" class="editor">${article.content}</textarea>
				</td>
			</tr>
			<tr>
				<th>
