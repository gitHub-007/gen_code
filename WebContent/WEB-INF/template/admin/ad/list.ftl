...
<title>${message("admin.ad.list")} - Powered By PTNETWORK</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.ad.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
	<form id="listForm" action="list" method="get">
		<div class="bar">
			...
			<div id="searchPropertyMenu" class="dropdownMenu">
				...
				<ul>
					<li[#if page.searchProperty == "title"] class="current"[/#if] val="title">${message("Ad.title")}</li>
				</ul>
			</div>
		</div>
		<table id="listTable" class="list">
			...
			[#list page.content as ad]
				<tr>
					...
					<td>
						<a href="edit?id=${ad.id}">[${message("admin.common.edit")}]</a>
					</td>
				</tr>
			[/#list]
		</table>
