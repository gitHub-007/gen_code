...
<title>${message("admin.specification.list")} - Powered By PTNETWORK</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.specification.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
	<form id="listForm" action="list" method="get">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="productCategory">${message("Specification.productCategory")}</a>
				</th>
				<th>
					<span>${message("Specification.options")}</span>
				</th>
				<th>
			...
			[#list page.content as specification]
				<tr>
					...
					<td>
						<a href="edit?id=${specification.id}">[${message("admin.common.edit")}]</a>
						<a href="add?sampleId=${specification.id}">[${message("admin.common.copy")}]</a>
					</td>
				</tr>
			[/#list]
		</table>
