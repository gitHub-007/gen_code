...
<title>${message("admin.memberDeposit.log")} - Powered By PTNETWORK</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.memberDeposit.log")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
