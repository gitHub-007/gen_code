...
<title>${message("admin.stock.log")} - Powered By PTNETWORK</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.stock.log")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
