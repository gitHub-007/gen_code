...
<title>${message("admin.storeCategory.edit")} - Powered By PTNETWORK</title>
	...
	<form id="inputForm" action="update" method="post">
		...
		<table class="input">
			<tr>
				...
				<td>
					<input type="text" name="name" value="${storeCategory.name}" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="bail" value="${storeCategory.bail}" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="order" value="${storeCategory.order}" class="text" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
