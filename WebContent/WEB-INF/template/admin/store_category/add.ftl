...
<title>${message("admin.storeCategory.add")} - Powered By PTNETWORK</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.storeCategory.add")}
	</div>
	<form id="inputForm" action="save" method="post">
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" name="bail" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
