...
<title>${message("admin.orderShipping.view")} - Powered By PTNETWORK</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.orderShipping.view")}
	</div>
	<ul id="tab" class="tab">
		<li>
