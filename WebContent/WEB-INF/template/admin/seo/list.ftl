...
<title>${message("admin.seo.list")} - Powered By PTNETWORK</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.seo.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
