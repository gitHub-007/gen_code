...
<title>${message("admin.seo.edit")} - Powered By PTNETWORK</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.seo.edit")}
	</div>
			...
			<tr>
				...
				<td>
					...
					<div class="tag">
						...
						[#elseif seo.type == "storeIndex"]
							<a href="javascript:;" val="[#noparse]${store.name}[/#noparse]">${message("admin.seo.storeName")}</a>
						[#elseif seo.type == "storeSearch"]
							<a href="javascript:;" val="[#noparse]${storeKeyword}[/#noparse]">${message("admin.seo.storeKeyword")}</a>
						[/#if]
