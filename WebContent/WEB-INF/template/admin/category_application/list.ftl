...
<title>${message("admin.categoryApplication.list")} - Powered By PTNETWORK</title>
...
<body>
	...
	<div class="breadcrumb">
		<a href="${base}/admin/common/index">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.categoryApplication.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
