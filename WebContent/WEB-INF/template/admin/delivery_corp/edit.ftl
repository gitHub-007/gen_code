...
<title>${message("admin.deliveryCorp.edit")} - Powered By PTNETWORK</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.deliveryCorp.edit")}
	</div>
	<form id="inputForm" action="update" method="post">
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" id="code" name="code" class="text" value="${deliveryCorp.code}" maxlength="200" title="${message("admin.deliveryCorp.codeTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
