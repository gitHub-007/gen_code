...
<title>${message("admin.login.title")} - Powered By PTNETWORK</title>
...
<body>
	<div class="login">
		<form id="loginForm" action="login" method="post">
			<table>
				<tr>
					<td width="190" rowspan="2" align="center" valign="bottom">
						[#--<img src="${base}/resources/admin/images/login_logo.gif" alt="PTNETWORK" />--]
			...
			<div class="powered">COPYRIGHT © 2008-${year} ptnetwork.NET ALL RIGHTS RESERVED.</div>
		</form>
	</div>
</body>
</html>