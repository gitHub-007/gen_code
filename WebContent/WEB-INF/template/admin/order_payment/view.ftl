...
<title>${message("admin.orderPayment.view")} - Powered By PTNETWORK</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.orderPayment.view")}
	</div>
	<table class="input">
		<tr>
			<th>
