...
<head>
	...
	<title>${message("business.product.add")} - Powered By PTNETWORK</title>
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<h1>${message("business.product.add")}</h1>
				<ol class="breadcrumb">
					<li>
									...
									<div class="box-body">
										...
										<div class="tab-content">
											<div id="base" class="tab-pane active">
												<div class="form-group">
													<label class="col-xs-2 control-label item-required">${message("Product.productCategory")}:</label>
													<div class="col-xs-4">
												...
												<div class="form-group">
													<label class="col-xs-2 control-label" for="sn">${message("Product.sn")}:</label>
													<div class="col-xs-4">
														<input id="sn" name="sn" class="form-control" type="text" maxlength="100" title="${message("business.product.snTitle")}">
													</div>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<div class="col-xs-4">
														<input id="cost" name="sku.cost" class="form-control" type="text" maxlength="16" title="${message("business.product.costTitle")}">
													</div>
												</div>
												<div class="form-group">
													<label class="col-xs-2 control-label" for="marketPrice">${message("Sku.marketPrice")}:</label>
													<div class="col-xs-4">
														<input id="marketPrice" name="sku.marketPrice" class="form-control" type="text" maxlength="16" title="${message("business.product.marketPriceTitle")}">
													</div>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<div class="col-xs-4">
														<input id="weight" name="weight" class="form-control" type="text" maxlength="9" title="${message("business.product.weightTitle")}">
													</div>
												</div>
												<div class="form-group">
													<label class="col-xs-2 control-label" for="rewardPoint">${message("Sku.rewardPoint")}:</label>
													<div class="col-xs-4">
														<input id="rewardPoint" name="sku.rewardPoint" class="form-control" type="text" maxlength="9" title="${message("business.product.rewardPointTitle")}">
													</div>
												</div>
														...
														<div class="col-xs-10">
															[#list promotions as promotion]
																<label class="checkbox-inline">
																	<input name="promotionIds" class="icheck" type="checkbox" value="${promotion.id}">
																	${promotion.name}
																</label>
															[/#list]
														</div>
												...
												[#if productTags?has_content]
													<div class="form-group">
														<label class="col-xs-2 control-label">${message("Product.productTags")}:</label>
														<div class="col-xs-10">
															[#list productTags as productTag]
																<label class="checkbox-inline">
																	<input name="productTagIds" class="icheck" type="checkbox" value="${productTag.id}">
																	${productTag.name}
																</label>
															[/#list]
														</div>
												...
												[#if storeProductTags?has_content]
													<div class="form-group">
														<label class="col-xs-2 control-label">${message("Product.storeProductTags")}:</label>
														<div class="col-xs-10">
															[#list storeProductTags as storeProductTag]
																<label class="checkbox-inline">
																	<input name="storeProductTagIds" class="icheck" type="checkbox" value="${storeProductTag.id}">
												...
												<div class="form-group">
													...
													<div class="col-xs-4">
														<input id="keyword" name="keyword" class="form-control" type="text" maxlength="200" title="${message("business.product.keywordTitle")}">
													</div>
												</div>
											</div>
