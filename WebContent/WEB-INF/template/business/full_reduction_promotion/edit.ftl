...
<head>
	...
	<title>${message("business.fullReductionPromotion.edit")} - Powered By PTNETWORK</title>
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<section class="content-header">
					<h1>${message("business.fullReductionPromotion.edit")}</h1>
					<ol class="breadcrumb">
						<li>
				...
				<section class="content">
					<div class="row">
						<div class="col-xs-12">
							<form id="fullReductionPromotionForm" class="form-horizontal" action="${base}/business/full_reduction_promotion/update" method="post">
											...
											<div id="base" class="tab-pane active">
												...
												<div class="form-group">
													...
													<div class="col-xs-10">
														<label class="checkbox-inline">
															<input id="useAmountPromotion" name="useAmountPromotion" class="icheck" type="checkbox" value="true"[#if promotion.conditionsAmount?? && promotion.creditAmount??] checked[/#if]>
															${message("business.fullReductionPromotion.useAmountPromotion")}
														</label>
														<label class="checkbox-inline">
															<input id="useNumberPromotion" name="useNumberPromotion" class="icheck" type="checkbox" value="true"[#if promotion.conditionsNumber?? && promotion.creditNumber??] checked[/#if]>
												...
												<div class="form-group">
													...
													<div class="col-xs-10">
														[#list memberRanks as memberRank]
															<label class="checkbox-inline">
																<input name="memberRankIds" class="icheck" type="checkbox" value="${memberRank.id}"[#if promotion.memberRanks?seq_contains(memberRank)] checked[/#if]>
																${memberRank.name}
															</label>
														[/#list]
													</div>
													...
													<div class="form-group">
														...
														<div class="col-xs-10">
															[#list coupons as coupon]
																<label class="checkbox-inline">
																	<input name="couponIds" class="icheck" type="checkbox" value="${coupon.id}"[#if promotion.coupons?seq_contains(coupon)] checked[/#if]>
																	${coupon.name}
																</label>
															[/#list]
														</div>
												...
												<div class="form-group">
													...
													<div class="col-xs-10 checkbox">
														<input id="isFreeShipping" name="isFreeShipping" type="text" value="${promotion.isFreeShipping?string("true", "false")}" data-toggle="checkbox-x">
														<label for="isFreeShipping" class="cbx-label">${message("Promotion.isFreeShipping")}</label>
														<input id="isCouponAllowed" name="isCouponAllowed" type="text" value="${promotion.isCouponAllowed?string("true", "false")}" data-toggle="checkbox-x">
														<label for="isCouponAllowed" class="cbx-label">${message("Promotion.isCouponAllowed")}</label>
														<input id="isEnabled" name="isEnabled" type="text" value="${promotion.isEnabled?string("true", "false")}" data-toggle="checkbox-x">
												...
												<div class="form-group">
													...
													<div class="col-xs-4">
														<select name="giftIds" class="gift-select form-control" title="${message("business.fullReductionPromotion.giftSelectTitle")}" multiple>
															[#list promotion.gifts as gift]
																<option value="${gift.id}" selected>
																	${gift.name}
																	[#if gift.specifications?has_content]
																		<span class="gray-darker">[${gift.specifications?join(", ")}]</span>
																	[/#if]
																</option>
															[/#list]
														</select>
