...
<head>
	...
	<title>${message("business.areaFreightConfig.add")} - Powered By PTNETWORK</title>
		...
		$areaFreightConfigForm.validate({
			rules: {
				areaId: {
					required: true,
					remote: {
						url: "${base}/business/area_freight_config/check_area?shippingMethodId=${shippingMethod.id}",
						cache: false
					}
				},
				firstWeight: {
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<h1>${message("business.areaFreightConfig.add")}</h1>
				<ol class="breadcrumb">
					<li>
					...
					<li class="active">${message("business.areaFreightConfig.add")}</li>
				</ol>
			</section>
			<section class="content">
				<div class="row">
					<div class="col-xs-12">
						<form id="areaFreightConfigForm" class="form-horizontal" action="${base}/business/area_freight_config/save" method="post">
							...
							<div class="box">
								<div class="box-body">
									<div class="form-group">
										...
										<div class="col-xs-4">
											<p class="form-control-static">${shippingMethod.name}</p>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-xs-4">
											<input id="firstWeight" name="firstWeight" class="form-control" type="text" maxlength="9">
										</div>
									</div>
									<div class="form-group">
										<label class="col-xs-2 control-label item-required" for="continueWeight">${message("FreightConfig.continueWeight")}:</label>
										<div class="col-xs-4">
											<input id="continueWeight" name="continueWeight" class="form-control" type="text" maxlength="9">
										</div>
									</div>
									<div class="form-group">
										<label class="col-xs-2 control-label item-required" for="firstPrice">${message("FreightConfig.firstPrice")}:</label>
										<div class="col-xs-4">
											<input id="firstPrice" name="firstPrice" class="form-control" type="text" maxlength="16">
										</div>
									</div>
									<div class="form-group">
										<label class="col-xs-2 control-label item-required" for="continuePrice">${message("FreightConfig.continuePrice")}:</label>
										<div class="col-xs-4">
											<input id="continuePrice" name="continuePrice" class="form-control" type="text" maxlength="16">
										</div>
									</div>
								</div>
