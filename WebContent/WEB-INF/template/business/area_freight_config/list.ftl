...
<head>
	...
	<title>${message("business.areaFreightConfig.list")} - Powered By PTNETWORK</title>
										...
										<tbody>
											[#list page.content as areaFreightConfig]
												<tr>
													...
													<td>${currency(areaFreightConfig.firstPrice, true)}</td>
													<td>${currency(areaFreightConfig.continuePrice, true)}</td>
													<td>
