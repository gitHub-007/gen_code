...
<head>
	...
	<title>${message("business.store.register")} - Powered By PTNETWORK</title>
	...
	$().ready(function() {
		...
		$storeRankServiceFee.velocity("fadeIn").text(currency($storeRankServiceFeeDefault, true));
		...
		// 店铺分类
		$storeCategoryBail.velocity("fadeIn").text(currency($storeCategoryBailDefault, true));
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<section class="content">
					<div class="row">
						<div class="col-xs-12">
							<form id="storeForm" class="form-horizontal" action="${base}/business/store/register" method="post">
								...
								<div class="box">
									<div class="box-body">
										<ul class="nav nav-tabs">
											...
											<li>
												<a href="#productCategorys" data-toggle="tab">${message("Store.productCategories")}</a>
											</li>
										</ul>
										<div class="tab-content">
											<div id="info" class="tab-pane active">
												...
												<div class="form-group[#if !storeRanks??] hidden-element[/#if]">
													<label class="col-xs-2 control-label item-required">${message("Store.storeRank")}:</label>
													<div class="col-xs-4">
												...
												<div class="form-group">
													...
													<div class="col-xs-4">
														<input id="mobile" name="mobile" class="form-control" type="text" maxlength="16">
													</div>
												</div>
												<div class="form-group">
											...
											<div id="productCategorys" class="tab-pane">
												<div class="form-group">
