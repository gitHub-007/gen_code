...
<head>
	...
	<title>${message("business.discountPromotion.list")} - Powered By PTNETWORK</title>
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<section class="content-header">
					<h1>${message("business.discountPromotion.list")}</h1>
					<ol class="breadcrumb">
						<li>
						...
						<li class="active">${message("business.discountPromotion.list")}</li>
					</ol>
				</section>
				<section class="content">
					<div class="row">
						<div class="col-xs-12">
							<form action="${base}/business/discount_promotion/list" method="get">
								...
								<div class="box">
									<div class="box-header">
										<div class="row">
											<div class="col-xs-9">
												<div class="btn-group">
													<a class="btn btn-default" href="${base}/business/discount_promotion/add">
													...
													[#if !currentStore.isSelf()]
														<a class="btn btn-default" href="${base}/business/discount_promotion/buy">
															<i class="fa fa-shopping-cart"></i>
															${message("business.discountPromotion.buy")}
														</a>
													[/#if]
											...
											<tbody>
												[#list page.content as promotion]
													<tr>
														...
														<td>
															<a href="${base}/business/discount_promotion/edit?promotionId=${promotion.id}">[${message("business.common.edit")}]</a>
