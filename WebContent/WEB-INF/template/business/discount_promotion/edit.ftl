...
<head>
	...
	<title>${message("business.discountPromotion.edit")} - Powered By PTNETWORK</title>
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<section class="content-header">
					<h1>${message("business.discountPromotion.edit")}</h1>
					<ol class="breadcrumb">
						<li>
						...
						<li class="active">${message("business.discountPromotion.edit")}</li>
					</ol>
				</section>
				<section class="content">
					<div class="row">
						<div class="col-xs-12">
							<form id="discountPromotionForm" class="form-horizontal" action="${base}/business/discount_promotion/update" method="post">
										...
										<div class="tab-content">
											<div id="base" class="tab-pane active">
												...
												<div class="form-group">
													...
													<div class="col-xs-4">
														<input id="discount" name="discount" class="form-control" type="text" value="${promotion.discount}" maxlength="9" title="${message("business.fullReductionPromotion.discountNote")}">
													</div>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<div class="col-xs-4">
														<select name="giftIds" class="gift-select form-control" title="${message("business.discountPromotion.giftSelectTitle")}" multiple>
