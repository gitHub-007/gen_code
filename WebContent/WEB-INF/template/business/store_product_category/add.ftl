...
<head>
	...
	<title>${message("business.storeProductCategory.add")} - Powered By PTNETWORK</title>
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<section class="content-header">
					<h1>${message("business.storeProductCategory.add")}</h1>
					<ol class="breadcrumb">
						<li>
						...
						<li class="active">${message("business.storeProductCategory.add")}</li>
					</ol>
				</section>
				<section class="content">
					<div class="row">
						<div class="col-xs-12">
							<form id="storeProductCategoryForm" class="form-horizontal" action="${base}/business/store_product_category/save" method="post">
								<div class="box">
									<div class="box-body">
