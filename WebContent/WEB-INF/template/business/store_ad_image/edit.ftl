...
<head>
	...
	<title>${message("business.storeAdImage.edit")} - Powered By PTNETWORK</title>
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<section class="content-header">
					<h1>${message("business.storeAdImage.edit")}</h1>
					<ol class="breadcrumb">
						<li>
						...
						<li class="active">${message("business.storeAdImage.edit")}</li>
					</ol>
				</section>
				<section class="content">
					<div class="row">
						<div class="col-xs-12">
							<form id="storeAdImageForm" class="form-horizontal" action="${base}/business/store_ad_image/update" method="post">
								<input name="storeAdImageId" type="hidden" value="${storeAdImage.id}">
								<div class="box">
									<div class="box-body">
										<div class="form-group">
											<label class="col-xs-2 control-label" for="title">${message("StoreAdImage.title")}:</label>
											<div class="col-xs-4">
												<input id="title" name="title" class="form-control" type="text" value="${storeAdImage.title}" maxlength="200">
											</div>
										</div>
										<div class="form-group">
											<label class="col-xs-2 control-label" for="url">${message("StoreAdImage.url")}:</label>
											<div class="col-xs-4">
												<input id="url" name="url" class="form-control" type="text" value="${storeAdImage.url}" maxlength="200">
											</div>
										</div>
										<div class="form-group">
											<label class="col-xs-2 control-label item-required">${message("StoreAdImage.image")}:</label>
											<div class="col-xs-4">
												<input name="image" type="hidden" value="${storeAdImage.image}" data-provide="fileinput" data-file-type="image">
											</div>
										</div>
										<div class="form-group">
											<label class="col-xs-2 control-label" for="order">${message("business.common.order")}:</label>
											<div class="col-xs-4">
												<input id="order" name="order" class="form-control" type="text" value="${storeAdImage.order}" maxlength="9">
											</div>
										</div>
									</div>
