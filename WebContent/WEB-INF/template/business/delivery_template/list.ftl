...
<head>
	...
	<title>${message("business.deliveryTemplate.list")} - Powered By PTNETWORK</title>
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<section class="content-header">
					<h1>${message("business.deliveryTemplate.list")}</h1>
					<ol class="breadcrumb">
						<li>
								...
								<div class="box">
									<div class="box-header">
										<div class="row">
											<div class="col-xs-9">
												<div class="btn-group">
													<a class="btn btn-default" href="${base}/business/delivery_template/add">
											...
											<tbody>
												[#list page.content as deliveryTemplate]
													<tr>
														...
														<td>
															<a href="${base}/business/delivery_template/edit?deliveryTemplateId=${deliveryTemplate.id}">[${message("business.common.edit")}]</a>
														</td>
													</tr>
												[/#list]
											</tbody>
