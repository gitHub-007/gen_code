...
<head>
	...
	<title>${message("business.deliveryTemplate.add")} - Powered By PTNETWORK</title>
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<section class="content-header">
					<h1>${message("business.deliveryTemplate.add")}</h1>
					<ol class="breadcrumb">
						<li>
				...
				<section class="content">
					<div class="row">
						<div class="col-xs-12">
							<form id="deliveryTemplateForm" class="form-horizontal" action="${base}/business/delivery_template/save" method="post">
								<div class="box">
									<div class="box-body">
										...
										<div class="form-group">
											...
											<div class="col-xs-10 checkbox">
												<input id="isDefault" name="isDefault" type="text" value="false" data-toggle="checkbox-x">
											</div>
										</div>
										<div class="form-group">
