...
<head>
	...
	<title>${message("business.stock.stockIn")} - Powered By PTNETWORK</title>
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<section class="content-header">
					<h1>${message("business.stock.stockIn")}</h1>
					<ol class="breadcrumb">
						<li>
						...
						<li class="active">${message("business.stock.stockIn")}</li>
					</ol>
				</section>
				<section class="content">
					<div class="row">
						<div class="col-xs-12">
							<form id="stockForm" class="form-horizontal" action="${base}/business/stock/stock_in" method="post">
								<div class="box">
									<div class="box-body">
										...
										<div class="form-group">
											<label class="col-xs-2 control-label item-required" for="quantity">${message("business.stock.stockInQuantity")}:</label>
											<div class="col-xs-4">
