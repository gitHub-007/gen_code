...
<head>
	...
	<title>${message("business.coupon.add")} - Powered By PTNETWORK</title>
										...
										<div class="tab-content">
											<div id="base" class="tab-pane active">
												...
												<div class="form-group">
													...
													<div class="col-xs-4">
														<input id="priceExpression" name="priceExpression" class="form-control" type="text" maxlength="200" title="${message("business.coupon.priceExpressionTitle")}">
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-xs-10 checkbox">
														...
														<input id="isExchange" name="isExchange" type="text" value="true" data-toggle="checkbox-x">
