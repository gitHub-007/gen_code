...
<head>
	...
	<title>${message("business.coupon.list")} - Powered By PTNETWORK</title>
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<section class="content-header">
					<h1>${message("business.coupon.list")}</h1>
					<ol class="breadcrumb">
						<li>
											...
											<tbody>
												[#list page.content as coupon]
													<tr>
														...
														<td>
															<a href="${base}/business/coupon/generate?couponId=${coupon.id}">[${message("business.coupon.generate")}]</a>
															<a href="${base}/business/coupon/edit?couponId=${coupon.id}">[${message("business.common.edit")}]</a>
														</td>
													</tr>
												[/#list]
											</tbody>
