...
<head>
	...
	<title>${message("business.order.view")} - Powered By PTNETWORK</title>
												...
												<div class="row">
													<div class="col-xs-6 col-xs-offset-2">
														<div class="form-group">
															...
															[/#if]
															<button id="refundsModalButton" class="btn btn-default" type="button" data-toggle="modal" data-target="#refundsModal"[#if order.refundableAmount <= 0] disabled[/#if]>${message("business.order.orderRefunds")}</button>
