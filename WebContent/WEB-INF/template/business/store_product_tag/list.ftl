...
<head>
	...
	<title>${message("business.storeProductTag.list")} - Powered By PTNETWORK</title>
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<section class="content-header">
					<h1>${message("business.storeProductTag.list")}</h1>
					<ol class="breadcrumb">
						<li>
						...
						<li class="active">${message("business.storeProductTag.list")}</li>
					</ol>
				</section>
				<section class="content">
					<div class="row">
						<div class="col-xs-12">
							<form action="${base}/business/store_product_tag/list" method="get">
								...
								<div class="box">
									<div class="box-header">
										<div class="row">
											<div class="col-xs-9">
												<div class="btn-group">
													<a class="btn btn-default" href="${base}/business/store_product_tag/add">
									...
									<div class="box-body table-responsive no-padding">
										<table class="table table-hover">
												...
												<tr>
													...
													<th>
														<a href="javascript:;" data-order-property="name">
															${message("StoreProductTag.name")}
															<i class="fa fa-sort"></i>
														</a>
													</th>
													<th>
														<a href="javascript:;" data-order-property="icon">
															${message("StoreProductTag.icon")}
															<i class="fa fa-sort"></i>
														</a>
													</th>
													<th>
														<a href="javascript:;" data-order-property="isEnabled">
															${message("StoreProductTag.isEnabled")}
															<i class="fa fa-sort"></i>
														</a>
													</th>
													<th>
											...
											<tbody>
												[#list page.content as storeProductTag]
													<tr>
														<td>
															<input name="ids" type="checkbox" value="${storeProductTag.id}">
														</td>
														<td>${storeProductTag.name}</td>
														<td>
															[#if storeProductTag.icon??]
																<a href="${storeProductTag.icon}" target="_blank">${message("business.storeProductTag.view")}</a>
															[#else]
																-
															[/#if]
														</td>
														<td>
															[#if storeProductTag.isEnabled]
																<i class="fa fa-check"></i>
															[#else]
																<i class="fa fa-times"></i>
															[/#if]
														</td>
														<td>${storeProductTag.order}</td>
														<td>${storeProductTag.memo}</td>
														<td>
															<a href="${base}/business/store_product_tag/edit?storeProductTagId=${storeProductTag.id}">[${message("business.common.edit")}]</a>
														</td>
													</tr>
												[/#list]
											</tbody>
