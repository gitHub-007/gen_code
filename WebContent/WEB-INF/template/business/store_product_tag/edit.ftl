...
<head>
	...
	<title>${message("business.storeProductTag.edit")} - Powered By PTNETWORK</title>
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<section class="content-header">
					<h1>${message("business.storeProductTag.edit")}</h1>
					<ol class="breadcrumb">
						<li>
						...
						<li class="active">${message("business.storeProductTag.edit")}</li>
					</ol>
				</section>
				<section class="content">
					<div class="row">
						<div class="col-xs-12">
							<form id="storeProductTagForm" class="form-horizontal" action="${base}/business/store_product_tag/update" method="post">
								<input name="storeProductTagId" type="hidden" value="${storeProductTag.id}">
								<div class="box">
									<div class="box-body">
										<div class="form-group">
											<label class="col-xs-2 control-label item-required" for="name">${message("StoreProductTag.name")}:</label>
											<div class="col-xs-4">
												<input id="name" name="name" class="form-control" type="text" value="${storeProductTag.name}" maxlength="200">
											</div>
										</div>
										<div class="form-group">
											<label class="col-xs-2 control-label">${message("StoreProductTag.icon")}:</label>
											<div class="col-xs-4">
												<input name="icon" type="hidden" value="${storeProductTag.icon}" data-provide="fileinput" data-file-type="image">
											</div>
										</div>
										<div class="form-group">
											<label for="isEnabled" class="col-xs-2 control-label">${message("StoreProductTag.isEnabled")}:</label>
											<div class="col-xs-10 checkbox">
												<input id="isEnabled" name="isEnabled" type="text" value="${storeProductTag.isEnabled?string("true", "false")}" data-toggle="checkbox-x">
											</div>
										</div>
										<div class="form-group">
											<label class="col-xs-2 control-label" for="memo">${message("StoreProductTag.memo")}:</label>
											<div class="col-xs-4">
												<input id="memo" name="memo" class="form-control" type="text" value="${storeProductTag.memo}" maxlength="200">
											</div>
										</div>
										<div class="form-group">
											<label class="col-xs-2 control-label" for="order">${message("business.common.order")}:</label>
											<div class="col-xs-4">
												<input id="order" name="order" class="form-control" type="text" value="${storeProductTag.order}" maxlength="9">
											</div>
										</div>
									</div>
