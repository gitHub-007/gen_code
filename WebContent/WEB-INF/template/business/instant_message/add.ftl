...
<head>
	...
	<title>${message("business.instantMessage.add")} - Powered By PTNETWORK</title>
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<section class="content-header">
					<h1>${message("business.instantMessage.add")}</h1>
					<ol class="breadcrumb">
						<li>
				...
				<section class="content">
					<div class="row">
						<div class="col-xs-12">
							<form id="instantMessageForm" class="form-horizontal" action="${base}/business/instant_message/save" method="post">
								<div class="box">
									<div class="box-body">
										...
										<div class="form-group">
											...
											<div class="col-xs-4">
												<input id="account" name="account" class="form-control" type="text" maxlength="10">
											</div>
										</div>
										<div class="form-group">
