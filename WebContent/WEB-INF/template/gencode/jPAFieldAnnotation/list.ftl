...
<body>
	...
	<form id="listForm" action="list" method="get">
		...
		<table id="listTable" class="list">
			...
			[#list page.content as jPAFieldAnnotation]
				<tr>
					<td>
						<input type="checkbox" name="ids" value="${jPAFieldAnnotation.id}" />
					</td>
					<td>
					</td>
					<td>
						<a href="edit?id=${jPAFieldAnnotation.id}">[${message("admin.common.edit")}]</a>
					</td>
				</tr>
			[/#list]
		</table>
