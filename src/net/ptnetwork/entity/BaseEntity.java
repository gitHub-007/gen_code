...
import net.ptnetwork.audit.AuditingEntityListener;
import net.ptnetwork.audit.CreatedDate;
import net.ptnetwork.audit.LastModifiedDate;
...
public abstract class BaseEntity<ID extends Serializable> implements Serializable {
	...
	@TableGenerator(name = "tableGenerator", table = "IdGenerator",allocationSize=1)
	private ID id;
