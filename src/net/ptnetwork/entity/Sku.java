...
public class Sku extends BaseEntity<Long> {
	 ...
	 */
	@Transient
	public net.ptnetwork.entity.Store getStore() {
	 ...
	 */
	@Transient
	public BigDecimal getCommission(net.ptnetwork.entity.Store.Type type) {
		...
		if (type != null && getProduct() != null && getProduct().getProductCategory() != null) {
			...
			if (net.ptnetwork.entity.Store.Type.general.equals(type) && productCategory.getGeneralRate() > 0) {
				commission = getPrice().multiply(new BigDecimal(productCategory.getGeneralRate().toString()));
			} else if (net.ptnetwork.entity.Store.Type.self.equals(type) && productCategory.getSelfRate() > 0) {
