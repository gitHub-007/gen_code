...
import net.ptnetwork.entity.PromotionPluginSvc;
...
public class FullReductionPromotionController extends BaseController {
	...
	public String save(@ModelAttribute("promotionForm") Promotion promotionForm, Boolean useAmountPromotion, Boolean useNumberPromotion, Long[] memberRankIds, Long[] couponIds, Long[] giftIds, @CurrentStore Store currentStore, RedirectAttributes redirectAttributes) {
		promotionForm.setType(Promotion.Type.fullReduction);
	 ...
	 */
	@PostMapping("/update")
	public String update(@ModelAttribute("promotionForm") Promotion promotionForm, @ModelAttribute(binding = false) Promotion promotion, Boolean useAmountPromotion, Boolean useNumberPromotion, Long[] memberRankIds, Long[] couponIds, Long[] giftIds, RedirectAttributes redirectAttributes) {
		if (promotion == null) {
			return UNPROCESSABLE_ENTITY_VIEW;
		}
	...
	public String list(Pageable pageable, @CurrentStore Store currentStore, ModelMap model) {
		...
		model.addAttribute("page", promotionService.findPage(currentStore, Promotion.Type.fullReduction, pageable));
