...
<title>${message("admin.plugin.weiboLogin.setting")} - Powered By PTNETWORK</title>
...
<body>
	<div class="breadcrumb">
		${message("admin.plugin.weiboLogin.setting")}
	</div>
	<form id="inputForm" action="update" method="post">
		<table class="input">
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.weiboLogin.oauthKey")}:
				</th>
				<td>
					<input type="text" name="oauthKey" class="text" value="${pluginConfig.getAttribute("oauthKey")}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.weiboLogin.oauthSecret")}:
				</th>
				<td>
					<input type="text" name="oauthSecret" class="text" value="${pluginConfig.getAttribute("oauthSecret")}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
