...
<title>${message("admin.plugin.alipayBankPayment.setting")} - Powered By PTNETWORK</title>
...
<body>
	<div class="breadcrumb">
		${message("admin.plugin.alipayBankPayment.setting")}
	</div>
	<form id="inputForm" action="update" method="post">
		<table class="input">
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.alipayBankPayment.partner")}:
				</th>
				<td>
					<input type="text" name="partner" class="text" value="${pluginConfig.getAttribute("partner")}" maxlength="200" />
					<a href="http://bizpartner.alipay.com/ptnetwork/" target="_blank">[${message("admin.plugin.alipayBankPayment.register")}]</a>
					<a href="https://b.alipay.com/order/pidKey.htm?pid=2088101227516250&product=fastpay" target="_blank">[${message("admin.plugin.alipayBankPayment.query")}]</a>
				</td>
			</tr>
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.alipayBankPayment.key")}:
				</th>
				<td>
