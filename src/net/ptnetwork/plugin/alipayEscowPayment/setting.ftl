...
<title>${message("admin.plugin.alipayEscowPayment.setting")} - Powered By PTNETWORK</title>
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					...
					<a href="http://bizpartner.alipay.com/ptnetwork/" target="_blank">[${message("admin.plugin.alipayEscowPayment.register")}]</a>
