 ...
 */
package net.ptnetwork.plugin.alipayDualPayment;
 ...
 * @version 5.0
 */
@Controller("adminAlipayDualPaymentController")
@RequestMapping("/admin/payment_plugin/alipay_dual_payment")
public class AlipayDualPaymentController extends BaseController {
	...
	public String setting(ModelMap model) {
		...
		return "/net/ptnetwork/plugin/alipayDualPayment/setting";
	}
