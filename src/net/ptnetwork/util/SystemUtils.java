 ...
 */
package net.ptnetwork.util;

import net.ptnetwork.CommonAttributes;
import net.ptnetwork.EnumConverter;
...
public final class SystemUtils {
    ...
    public static Setting getSetting() {
        ...
        if (cacheElement == null) {
            ...
            try {
                File ptnetworkXmlFile = new ClassPathResource(CommonAttributes.PTNETWORK_XML_PATH).getFile();
                Document document = new SAXReader().read(ptnetworkXmlFile);
                List<org.dom4j.Element> elements = document.selectNodes("/ptnetwork/setting");
    ...
    public static void setSetting(Setting setting) {
        ...
        try {
            ...
            try {
                ...
                xmlWriter = new XMLWriter(new FileOutputStream(ptnetworkXmlFile), outputFormat);
    ...
    public static TemplateConfig getTemplateConfig(String id) {
        ...
        if (cacheElement == null) {
            ...
            try {
                File ptnetworkXmlFile = new ClassPathResource(CommonAttributes.PTNETWORK_XML_PATH).getFile();
                Document document = new SAXReader().read(ptnetworkXmlFile);
                org.dom4j.Element element = (org.dom4j.Element) document.selectSingleNode("/ptnetwork/templateConfig" +
																								  "[@id='" + id +
																								  "']");
                if (element != null) {
    ...
    public static List<TemplateConfig> getTemplateConfigs(TemplateConfig.Type type) {
        ...
        if (cacheElement == null) {
            ...
            try {
                File ptnetworkXmlFile = new ClassPathResource(CommonAttributes.PTNETWORK_XML_PATH).getFile();
                Document document = new SAXReader().read(ptnetworkXmlFile);
                List<org.dom4j.Element> elements = document.selectNodes(type != null ? "/ptnetwork/templateConfig[@type='" + type + "']" : "/ptnetwork/templateConfig");
                for (org.dom4j.Element element : elements) {
